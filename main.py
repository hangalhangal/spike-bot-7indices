    ...
    while True:
        ...
        for item in items:
            ...
            for key,info in INDICES.items():
                ...
                full_name_norm=_norm_symbol_text(
                    info["name"]
                )

                short_name_norm=_norm_symbol_text(
                    info["name"].replace(
                        "Index",
                        ""
                    )
                ...
                if (
                    sym_norm==key_norm
                    or
                    name_norm==full_name_norm
                    or
                    name_norm==short_name_norm
                ):
...
async def auto_start(application):
    ...
    """
    GitHub/Render зэрэг deploy орчинд
    /start дарах шаардлагагүй.

    Bot бүрэн startup хийсний дараа
    яг 7 индексийг идэвхжүүлнэ.
    """

    logging.info(
        "AUTO START: activating 7 indices..."
    )
