...
def calculate_market_structure(symbol):
    ...
    #
    # IMPORTANT:
    # BOS and CHoCH are now mutually exclusive.
    # ========================================================
    ...
    if (
        ...
        # Break below HL = Change of Character
        if current_price < latest_low:

            choch = "BEARISH"

        # Break above HH = continuation BOS
    ...
    # --------------------------------------------------------
        ...
        # Break above LH = Change of Character
        if current_price > latest_high:

            choch = "BULLISH"

        # Break below LL = continuation BOS
    ...
    # LH + HL
    #
    # No BOS / CHoCH until clearer structure.
    # --------------------------------------------------------
    ...
    # MOVE STRENGTH
    #
    # Normalized by ATR * sqrt(lookback)
    # ========================================================
...
def calculate_features(symbol):
    ...
    calculate_market_structure(symbol)
