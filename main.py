...
# ============================================================
# 🧠 AI MANIAC V5 FIX
# ЗӨВХӨН ЭДГЭЭР 7 BOOM / CRASH INDEX
# ============================================================
...
DERIV_WS_URI="wss://ws.binaryws.com/websockets/v3?app_id=1089"
...
async def deriv_ws(k,app):
    ...
    try:
        ...
        async with websockets.connect(
            ...
            # "subscribe": 0 REMOVED.
            #
            # The one-time ticks_history request does NOT
            # need subscribe.
            # ------------------------------------------------
            ...
            while k in active:
                ...
                if (
                    ...
                    # ------------------------------------------------
                    # Put latest historical ticks into live buffer
                    # ------------------------------------------------
                ...
                if (
                    ...
                    # --------------------------------------------
                    # ONLINE LEARNING / RESULT EVALUATION
                    # --------------------------------------------
...
def allowed(k,c,conf):
    ...
    # AI бүрэн warm-up хийгдээгүй үед сигнал хориглоно.
